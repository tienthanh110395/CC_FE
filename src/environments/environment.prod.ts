...
export const COMMOM_CONFIG = {
  ...
  BASE_URL: 'http://10.60.156.162:9595/',
  HOST_KEY_CLOAK: 'http://10.60.156.159:8080',
  CLIENT_ID: 'cc-public',
  ...
  DATE_TIME_FORMAT_1: 'dd/MM/yyyy HH:mm:ss',
  DATE_TIME_FORMAT_3: 'DD/MM/YYYY HH:mm:ss',
  REQUIRE_DOCUMENT: window["env"]["REQUIRE_DOCUMENT"]
}
